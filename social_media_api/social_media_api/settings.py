...
SECRET_KEY = 'django-insecure-h%u^hm*a81tq8=4)a7w+4ux*6p!+zj-b^=m4x-r!i%)llx1!_@'
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Corrected from 'path.os.join' to 'os.path.join'
